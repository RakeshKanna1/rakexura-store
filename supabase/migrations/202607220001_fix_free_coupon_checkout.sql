-- Migration: 202607220001_fix_free_coupon_checkout.sql
-- Allow 100% off discounts for valid active promo coupon codes (like RAKEFREE) regardless of loyalty points
