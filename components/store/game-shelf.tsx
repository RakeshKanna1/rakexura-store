...
export function GameShelf({ title, subtitle, games, href = "/games" }: { title: string; subtitle?: string; games: Game[]; href?: string }) {
  ...
  return (
    <section className="section-space w-full max-w-full overflow-hidden">
      ...
      <div
        className="hide-scrollbar grid w-full max-w-full auto-cols-[170px] grid-flow-col gap-4 overflow-x-auto pb-3 overscroll-x-contain sm:auto-cols-[210px] md:auto-cols-[240px] lg:grid-flow-row lg:grid-cols-5 xl:grid-cols-6 lg:overflow-visible lg:pb-0 scroll-smooth snap-x snap-proximity"
        style={{
