...
export function WishlistButton({
  ...
  const getContainerStyle = () => {
    ...
    if (variant === "card") {
      return "relative flex h-8 w-8 items-center justify-center rounded-full border border-white/15 bg-black/75 backdrop-blur-md hover:scale-110 hover:border-white/40 hover:bg-black/90 active:scale-90 transition-all duration-200 overflow-visible cursor-pointer select-none";
    }
