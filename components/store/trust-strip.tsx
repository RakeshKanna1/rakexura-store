...
const points = [
  { icon: BadgeCheck, value: "Verified", label: "payment review" },
  { icon: BatteryPlusIcon, value: "Instant", label: "assisted delivery" },
  { icon: ArrowDownloadIcon, value: "Secure", label: "order key tracking" },
  { icon: PlugConnectedIcon, value: "Live Sync", label: "WhatsApp support" }
];
