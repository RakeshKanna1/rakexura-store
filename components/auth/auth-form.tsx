...
import { Gamepad2, MailCheck, RefreshCw, ShieldCheck, ArrowRight, Eye, EyeOff, Loader2, ChevronLeft, CheckCircle2, MessageSquare, User } from "lucide-react";
...
export function AuthForm({ mode, next = "/dashboard" }: { mode: "login" | "register"; next?: string }) {
  ...
  return (
    <div className="space-y-4" suppressHydrationWarning>
      <div className="glass mx-auto max-w-md overflow-hidden rounded-2xl border border-white/10 bg-[#08090c]/90 p-6 md:p-8 backdrop-blur-xl shadow-2xl" suppressHydrationWarning>
        {mode === "login" ? (
