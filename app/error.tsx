...
export default function Error({
  ...
  return (
    <main className="min-h-[75vh] flex items-center justify-center px-4 py-16 select-none">
      ...
      <div className="relative z-10 w-full max-w-md text-center rounded-2xl border border-white/[0.08] bg-[#0c0f18]/90 p-8 sm:p-10 shadow-2xl backdrop-blur-xl">
        ...
        <p className="mt-2.5 text-xs sm:text-sm leading-relaxed text-[#8991a6] max-w-sm mx-auto">
        ...
        <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="w-full sm:w-auto inline-flex min-h-[40px] items-center justify-center gap-2 rounded-full border border-white/20 bg-white/[0.05] px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white transition-all hover:bg-white/[0.1] hover:border-white/40 active:scale-95"
          >
