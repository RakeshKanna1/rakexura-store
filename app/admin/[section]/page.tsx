...
const sources = {
  ...
  customers: { title: "Customer list", table: "profiles", select: "id,display_name,whatsapp,role,is_reseller,reseller_discount,reseller_discount_type,created_at", order: "created_at" },
