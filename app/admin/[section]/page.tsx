...
const sources = {
  ...
  customers: { title: "Customer list", table: "profiles", select: "id,display_name,whatsapp,role,is_reseller,reseller_discount,created_at", order: "created_at" },
...
export default async function AdminSection({ params, searchParams }: { params: Promise<{ section: string }>; searchParams: Promise<{ edit?: string }> }) {
  ...
  const hidden = new Set(["screenshot_url", "proof_url", "media_urls", "media_links", "reseller_discount"]);
