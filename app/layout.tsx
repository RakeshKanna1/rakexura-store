      ...
      <body className={geist.className} suppressHydrationWarning>
        <AppProviders>
          ...
          <div className="border-b border-white/[0.06] bg-[#07090e] py-1 sm:py-1.5 text-center select-none overflow-hidden">
            <div className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 text-[10px] sm:text-xs whitespace-nowrap">
              ...
              <span className="text-white/25 text-[9px] select-none shrink-0">•</span>
              <span className="text-[#c3c9d8] truncate text-[10px] sm:text-xs">Save on curated collections</span>
              <Link 
                href="/bundles" 
